...
public void SetData(JsonCondOwner jid, bool bLoot = true, JsonCondOwnerSave jCOSIn = null)
{
	...
	{
		strNameShortLCase = jid.strNameShort.ToLower();
	}
	strDesc = jid.strDesc;
	...
	if (jCOSIn != null)
	{
		...
		if (flag3 && num16 < 6)
		{
			...
			Debug.LogWarning("Repairing missing pledges on " + pspec.strFirstName + " " + pspec.strLastName + ". Found: " + num16 + ". Using " + pspec.strLootIAAdds);
